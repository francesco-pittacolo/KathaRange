...
## What is it?
**CyForge** is a cybersecurity network-emulation system based on the Kathará Framework API (https://github.com/KatharaFramework/Kathara).  
It allows you to create dynamic,
